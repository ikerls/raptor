...
- Run enabled numbered scripts from one Containerfile layer with
  `for script in /ctx/build/[1-9]*.sh`; this preserves numeric order and skips
  disabled `.sh.example` scripts without maintaining a manual command list.
